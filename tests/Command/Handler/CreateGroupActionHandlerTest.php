...
use Tourze\LarkAppBotBundle\Command\Handler\CreateGroupActionHandler;
 ...
 * @internal
 */
#[CoversClass(CreateGroupActionHandler::class)]
#[RunTestsInSeparateProcesses]
final class CreateGroupActionHandlerTest extends AbstractIntegrationTestCase
{
    ...
    public function testGetActionName(): void
    {
        ...
        $this->assertSame('create', $handler->getActionName());
    }

    public function testExecuteRequiresName(): void
    {
    ...
    public function testExecuteCreatesGroup(): void
    {
        $groupService = $this->createMock(GroupService::class);
        ...
        $input = new ArrayInput(['--name' => 'New Group', '--description' => 'Test'], $this->createInputDefinition());
        $output = new BufferedOutput();
        $io = new SymfonyStyle($input, $output);

        $result = $handler->execute(null, $input, $io);
